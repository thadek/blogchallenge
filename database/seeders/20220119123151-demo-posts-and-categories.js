  ...
  async up(queryInterface, Sequelize) {
    return Promise.all([
      ...
      Post.bulkCreate([{
          ...
          updatedAt: new Date('2022-01-01T20:24:00')
        },
        {
          ...
          updatedAt: new Date('2022-01-02T20:21:00')
        }, 
        {
          ...
          updatedAt: new Date('2022-01-03T20:11:00')
        }, 
        {
          ...
          updatedAt: new Date('2022-01-04T20:12:00')
        }, 
        {
          ...
          updatedAt: new Date('2022-01-05T20:14:00')
        },{
          ...
          updatedAt: new Date('2022-01-06T20:43:00')
        }
      ])
    ])
